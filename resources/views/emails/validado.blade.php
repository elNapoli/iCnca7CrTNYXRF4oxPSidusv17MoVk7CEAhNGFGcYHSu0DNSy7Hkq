                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="174" height="60" align="middle">
                                                <div class="imgpop">
                                                   <p style="font-family: Cabin; color:white; font-size: 32px; width: 560px">VERIFICADO/A </p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="200" height="150" align="center" class="devicewidth">
                                                            <img src="https://help.quavermusic.com/integrations/wp-content/uploads/sites/2/2017/04/pass-icon.png" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                      </tr>
                                                      <!-- /image -->
                                                   </tbody>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            Estimad@ {{ $destinatario }}, te informamos que tu cuenta ha sido validada con éxito, ya puedes hacer uso de la plataforma online.
                                                         </td>
                                                         </td>
                                                      </tr>
                                             ...
                                             <td>
                                                ...
                                                <table width="200" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="200" height="150" align="center" class="devicewidth">
                                                            <img src="https://cdn2.iconfinder.com/data/icons/my-cubicle/512/Pin_Note-512.png" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                         </td>
                                                      </tr>
                                                      <!-- /image -->
                                                   </tbody>
                                                ...
                                                <table width="300" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidthmob">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #7a6e67; text-align:left; line-height: 24px;" class="padding-right15">
                                                            Recuerda hacer buen uso de este servicio (Condiciones de uso). Para cualquier consulta puedes escribirnos mediante el foro interno o al correo movilidadestudiantil@uach.cl
                                                         </td>
                                                      </tr>
                                                      <!-- end of content -->
                                                   </tbody>
                                 ...
                                 <td>
                                    <table width="520" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #2d2a26; text-align:center; line-height: 28px;">
                                                <a href="#"><button class="button" id="irAdmin"style="vertical-align:middle"><span>Ir a OME</span></button></a>
                                             </td>
                                          </tr>
                                          <!-- Spacing -->
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td width="174" height="40" align="left">
                                                <div class="imgpop">
                                                   ...
                                                   <p style="font-family: Cabin; color:white; font-size: 14px; width: 400; height: 20px; padding-left: 2em">www.sitioweb.cl</p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
