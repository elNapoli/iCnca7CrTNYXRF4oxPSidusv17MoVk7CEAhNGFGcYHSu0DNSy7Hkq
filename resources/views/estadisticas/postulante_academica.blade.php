...
d3.json("/json_postbystudy.json", function(error, root) {
...
if(d.parent){
    ...
    d3.select("#p1")
        .text('De un total de '+cant+' postulantes '+d.size+' se encuentran en '+d.name+' y equivalen  respecto al total en un');
