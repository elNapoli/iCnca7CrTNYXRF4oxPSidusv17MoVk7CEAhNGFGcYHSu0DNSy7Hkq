<div class="ledad">
<p>Yo conrifmo que la información que he entregado en esta solicitud es verdadera, completa y precisa. Además me he informado de lo siguiente:</p>
<ul>
...
<div class="form-group">
	...
	<li class="text-danger">El estudiante se compromete a enviar todos los documentos que se requieren una vez que se encuentre en el extranjer, si modifica asignaturas que estas sean autorizadas por la Dirección de Escuela y modificar su inscripción de asignaturas a través  de info-alumnos en los períodos informados por la UACh. Esta modificación debe realizarse de acuerdo al documento de homologación que ha firmado con su director/a de escuela.</li>




	<li>El estudiante ha sido informado de los documentos necesarios para realizar estudios en el país de destino <strong><u>(Carta de aceptacińo original, visa de estudiante, seguro medico </u></strong>y otros documentos necesarios por lo que se aconseja comunicarse con la embajada del país en el que realizará estudios).</li>
